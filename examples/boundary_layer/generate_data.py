...
def plot_profile(f_z, v_norm, z_span, z_max=10, fname=None):
    u_norm = f_z
...
def main():
    ...
    if PLOT_FIELDS: plot_fields(N=200, bounds=bounds[:2], Re=5e4, U_inf=1, add_noise=ADD_NOISE)
    if PLOT_PROFILE: plot_profile(f_z, v_norm, z_span, z_max=10)
