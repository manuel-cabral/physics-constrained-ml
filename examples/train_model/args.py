...
sampling_box = (-0.5, 3.0, -0.5, 0.5) # None # xmin, xmax, ymin, ymax
...
# Model
x_vars = ["x", "y"] # MLP inputs (x, y; parameters...)
...
learning_rate_adam = 1e-3 # learning rate for ADAM optimizer
learning_rate_lbfgs = 1 # learning rate for L-BFGS optimizer
patience = 6 # number of epochs of patience before training is stopped when validation loss is not reduced
